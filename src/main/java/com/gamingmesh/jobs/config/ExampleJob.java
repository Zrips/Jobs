...
public class ExampleJob {
    ...
    public static void updateExampleFile() {
        ...
        cfg.addComment(pt + ".Vax", "Payment for vaxing blocks, only for 1.17+ servers");
        generate(cfg, pt + ".Vax.COPPER_BLOCK", 4, 4);
        generate(cfg, pt + ".Vax.EXPOSED_COPPER", 4.5, 4.5);
        generate(cfg, pt + ".Vax.WEATHERED_COPPER", 5, 5);
        generate(cfg, pt + ".Vax.OXIDIZED_COPPER", 6, 6);
        generate(cfg, pt + ".Vax.CUT_COPPER", 5, 5);
        generate(cfg, pt + ".Vax.EXPOSED_CUT_COPPER", 5.5, 5.5);
        generate(cfg, pt + ".Vax.WEATHERED_CUT_COPPER", 6, 6);
        generate(cfg, pt + ".Vax.OXIDIZED_CUT_COPPER", 7, 7);
        generate(cfg, pt + ".Vax.CUT_COPPER_STAIRS", 5.5, 5.5);
        generate(cfg, pt + ".Vax.EXPOSED_CUT_COPPER_STAIRS", 6, 6);
        generate(cfg, pt + ".Vax.WEATHERED_CUT_COPPER_STAIRS", 6.5, 6.5);
        generate(cfg, pt + ".Vax.OXIDIZED_CUT_COPPER_STAIRS", 7.5, 7.5);
        generate(cfg, pt + ".Vax.CUT_COPPER_SLAB", 5, 5);
        generate(cfg, pt + ".Vax.EXPOSED_CUT_COPPER_SLAB", 5.5, 5.5);
        generate(cfg, pt + ".Vax.WEATHERED_CUT_COPPER_SLAB", 6, 6);
        generate(cfg, pt + ".Vax.OXIDIZED_CUT_COPPER_SLAB", 7, 7);
        generate(cfg, pt + ".Vax.CHISELED_COPPER", 6, 6);
        generate(cfg, pt + ".Vax.EXPOSED_CHISELED_COPPER", 6.5, 6.5);
        generate(cfg, pt + ".Vax.WEATHERED_CHISELED_COPPER", 7, 7);
        generate(cfg, pt + ".Vax.OXIDIZED_CHISELED_COPPER", 8, 8);

...
public class LanguageManager {
    ...
    void load() {
        ...
        for (String lang : languages) {
            ...
            Map<String, List<String>> cmdArgs = Jobs.getGCManager().getCommandArgs();
            ...
            cmdArgs.put("boost", Arrays.asList("[jobname]", "reset%%exp%%money%%points", "[time]%%2", "%%2"));
            ...
            cmdArgs.put("schedule", Arrays.asList("enable", "[scheduleName]", "[untilTime]"));
            ...
            cmdArgs.put("edititembonus", Arrays.asList("list%%add%%remove", "[boosteditems]"));

            c.get("command.bonus.help.info", "Show job bonuses");
            c.get("command.bonus.help.args", "[jobname]");
            cmdArgs.put("bonus", Arrays.asList("[jobname]"));
            ...
            cmdArgs.put("resetexploreregion", Arrays.asList("world", "[worldname]"));
            cmdArgs.put("resetlimit", Arrays.asList("[playername]"));
            cmdArgs.put("resetquesttotal", Arrays.asList("[playername]%%all"));
            cmdArgs.put("resetquest", Arrays.asList("[playername]", "[jobname]"));

            c.get("command.points.help.info", "Shows how much points does a player have.");
            c.get("command.points.help.args", "[playername]");
            cmdArgs.put("points", Arrays.asList("[playername]"));
            ...
            cmdArgs.put("editpoints", Arrays.asList("set%%add%%take", "[playername]"));
            ...
            cmdArgs.put("placeholders", Arrays.asList("parse%%", "[placeholder]"));
            ...
            cmdArgs.put("recalculatepermissions", Arrays.asList("[playername]"));
            ...
            cmdArgs.put("archive", Arrays.asList("[playername]"));
            ...
            cmdArgs.put("give", Arrays.asList("[playername]", "[jobname]", "items%%limiteditems", "[jobitemname]"));
            ...
            cmdArgs.put("info", Arrays.asList("[jobname]", "[action]"));
            ...
            cmdArgs.put("playerinfo", Arrays.asList("[playername]", "[jobname]", "[action]"));

            c.get("command.join.help.info", "Join the selected job.");
            c.get("command.join.help.args", "[jobfullname]");
            cmdArgs.put("join", Arrays.asList("[jobfullname]"));
            ...
            cmdArgs.put("leave", Arrays.asList("[oldplayerjob]"));
            ...
            cmdArgs.put("ownedblocks", Arrays.asList("[playername]"));
            ...
            cmdArgs.put("clearownership", Arrays.asList("[playername]"));
            ...
            cmdArgs.put("skipquest", Arrays.asList("[jobname]", "[questname]", "[playername]"));

            c.get("command.quests.help.info", "List available quests");
            c.get("command.quests.help.args", "[playername]");
            cmdArgs.put("quests", Arrays.asList("[playername]"));
            ...
            cmdArgs.put("fire", Arrays.asList("[playername]", "[jobname]"));
            ...
            cmdArgs.put("fireall", Arrays.asList("[playername]"));
            ...
            cmdArgs.put("employ", Arrays.asList("[playername]", "[jobname]"));
            ...
            cmdArgs.put("area", Arrays.asList("add%%remove%%info%%list"));
            ...
            cmdArgs.put("log", Arrays.asList("[playername]"));
            ...
            cmdArgs.put("transfer", Arrays.asList("[playername]", "[oldjob]", "[newjob]"));
            ...
            cmdArgs.put("promote", Arrays.asList("[playername]", "[jobname]", "[levels]", "%%-cmd"));
            ...
            cmdArgs.put("exp", Arrays.asList("[playername]", "[jobname]", "set%%add%%take"));
            ...
            cmdArgs.put("level", Arrays.asList("[playername]", "[jobname]", "set%%add%%take"));
            ...
            cmdArgs.put("demote", Arrays.asList("[playername]", "[jobname]", "[levels]"));
            ...
            cmdArgs.put("deluser", Arrays.asList("[playername]"));
            ...
            cmdArgs.put("grantxp", Arrays.asList("[playername]", "[jobname]", "[xp]"));
            ...
            cmdArgs.put("removexp", Arrays.asList("[playername]", "[jobname]", "[xp]"));
            ...
            cmdArgs.put("signupdate", Arrays.asList("[jobname]"));
            ...
            cmdArgs.put("toggle", Arrays.asList("actionbar%%bossbar%%chattext", "off%%rapid%%batched"));

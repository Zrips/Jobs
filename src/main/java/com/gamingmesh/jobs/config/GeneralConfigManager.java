...
//	PurgeUse = c.get("Optimizations.Purge.Use", false);
	...
	c.addComment("ActionBars.Messages.EnabledByDefault", "When this set to true player will see action bar messages by default, When false, players will see chat messages instead.");

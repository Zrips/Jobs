...
public class JobItems {
	...
	public JobItems(String node, int id, int data, int amount, String name, List<String> lore,
			HashMap<Enchantment, Integer> enchants, double moneyBoost, double pointBoost, double expBoost) {
		this.node = node;
		this.id = id;
		this.data = data;
		this.amount = amount;

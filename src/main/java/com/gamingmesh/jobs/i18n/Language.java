...
public class Language {
	...
	public String getMessage(String key, Object... variables) {
		...
		if (customlocale == null || !customlocale.contains(key))
			msg = enlocale.contains(key) == true ? ChatColor.translateAlternateColorCodes('&', enlocale.getString(key))
					: missing;
		else
			msg = customlocale.contains(key) == true
					? ChatColor.translateAlternateColorCodes('&', customlocale.getString(key)) : missing;
	...
	public String getDefaultMessage(String key) {
		return enlocale.contains(key) == true ? ChatColor.translateAlternateColorCodes('&', enlocale.getString(key))
				: "Cant find locale";
	}
